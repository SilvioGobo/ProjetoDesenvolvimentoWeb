...
<body>
    <div class="container">
        ...
        <hr>
        <a href="/veiculos/criar" class="btn btn-novo">
            + Novo Veículo
        </a>
        <br><br>
                ...
                <?php else: ?>
                    <?php foreach ($veiculos as $veiculo): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/veiculos/atualizar?id=<?php echo $veiculo->getId(); ?>" class="btn-editar">Editar</a>
                                |
                                <a href="/veiculos/deletar?id=<?php echo $veiculo->getId(); ?>"
                                   onclick="return confirm('Tem certeza que deseja excluir?');" class="btn-excluir">
                                   Excluir
                                </a>
                            </td>
                        </tr>
